              ...
              <div style={{marginTop: '1rem', display:'flex', gap:'2rem', alignItems: 'center'}}>
                ...
                {f.type === 'text' && (
                  <>
                    <div style={{display:'flex', alignItems:'center', gap:'0.5rem'}}>
                      ...
                      <input type="number" style={{width:'80px', padding:'0.25rem'}} value={f.min_length || ''} onChange={e => updateField(i, 'min_length', parseInt(e.target.value))} />
                    </div>
                    <div style={{display:'flex', alignItems:'center', gap:'0.5rem'}}>
                      <label style={{margin:0}}>Max Len:</label>
                      <input type="number" style={{width:'80px', padding:'0.25rem'}} value={f.max_length || ''} onChange={e => updateField(i, 'max_length', parseInt(e.target.value))} />
                    </div>
                  </>
                )}
                ...
                {f.type === 'dropdown' && (
                  <div style={{flex: 1}}>
                    ...
                    <input style={{padding:'0.25rem'}} value={(f.options || []).join(',')} onChange={e => updateField(i, 'options', e.target.value.split(',').map(s=>s.trim()))} />
                  </div>
                )}
              </div>
            </div>
